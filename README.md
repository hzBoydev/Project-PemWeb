...
2. Verifikasi database connection di db.php
3. Pastikan semua folder uploads ada dan writable
4. Cek session_start() di setiap file

**Folder penting yang harus ada:**
- `public/uploads/cars/` (permission 755)
- `public/uploads/proofs/` (permission 755)
- `app/config/db.php` (konfigurasi database)
